...
class DetailHomeAllScreen extends StatefulWidget {
  const DetailHomeAllScreen({super.key});
  static Widget create() {
    return MultiProvider(
      ...
      child: const DetailHomeAllScreen(),
    );
  }

  @override
  State<DetailHomeAllScreen> createState() => _DetailHomeAllScreenState();
}

class _DetailHomeAllScreenState extends State<DetailHomeAllScreen> {
   @override
  void initState() {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        iconTheme: IconThemeData(
         ...
         backgroundColor: greyBlack,
        title: Text("Detail All Game",style: TextStyles.body1,),
        centerTitle: true,
      ),
