...
class DetailHomePlatformScreen extends StatefulWidget {
  const DetailHomePlatformScreen({super.key});
  static Widget create() {
    return MultiProvider(
      ...
      child: const DetailHomePlatformScreen(),
    );
  }

  @override
  State<DetailHomePlatformScreen> createState() => _DetailHomePlatformScreenState();
}

class _DetailHomePlatformScreenState extends State<DetailHomePlatformScreen> {
 String? selectedItem;
  @override
  void initState() {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        iconTheme: IconThemeData(
         ...
         backgroundColor: greyBlack,
        title: Text("Detail Game Platform",style: TextStyles.body1,),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
             AppDropdown(
              ...
              onChanged: (value) {
                setState(() {
                 ...
                 viewModel.getGameByPlatform(value!.toLowerCase());
              },
           ...
           Center(child: CircularProgressIndicator(),)
            : selectedItem == null ? 
            Center(child: Text("Silahkan Pilih Platform Terlebih Dahulu",style: TextStyles.body1,textAlign: TextAlign.center))
            :  viewModel.listGame.isEmpty ? 
            Center(child: Text("Game Dengan Platform $selectedItem Tidak Ada",style: TextStyles.body1,textAlign: TextAlign.center),)  
            : Wrap(
              spacing: 10,
              runSpacing: 10,
